...
For a complete implementation, see [Custom Paging](../advanced-topics/custom-paging.md).
...
MySqlBuilder.Instance.RegisterFunctionSqlHandler("DATE_FORMAT", (ref ValueStringBuilder outSql, FunctionExpr expr, SqlBuildContext context) =>
{
...
If the function comes from Lambda or member extensions, you also need to register the corresponding conversion logic in `LambdaExprConverter`. See [Expression Extension](./expression-extension.en.md).
...
- [Custom Paging](../advanced-topics/custom-paging.en.md)
