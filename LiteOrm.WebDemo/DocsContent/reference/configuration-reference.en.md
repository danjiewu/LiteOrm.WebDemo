...
For the `Provider` value of each database (including domestic/compatible databases), see [Database Compatibility Notes](./database-compatibility.en.md).
...
> If you don't need Autofac / AOP, you can use the base library's built-in `AddLiteOrm()` (plain MS DI, called on `builder.Services`). See [First Complete Example (Base Library Only)](../getting-started/first-example.en.md).
...
- [First End-to-End Example (DI)](../getting-started/first-example-di.en.md)
- [Transactions](../di/transactions.en.md)
- [Logging and Diagnostics](../di/logging.en.md)
- [Performance](../advanced-topics/performance.en.md)
