...
LiteOrm ships with the following 6 builders for domestic / compatible databases. For the development guide (base-class selection, integration steps, dialect quick reference), see [Domestic / Compatible Database SqlBuilder Guide](../extensibility/domestic-database-sqlbuilder.en.md).
