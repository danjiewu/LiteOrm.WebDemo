...
LiteOrm 内置以下 6 个国产 / 兼容数据库构建器。开发指南（基类选择、接入步骤、差异速查）见[国产 / 兼容数据库 SqlBuilder 开发指南](../extensibility/domestic-database-sqlbuilder.md)。
...
参考文档：
- [自定义分页](../advanced-topics/custom-paging.md)
...
| MySQL | `MySqlBulkCopy` | 无（Demo 中有 [MySqlBulkInsertProvider](https://github.com/danjiewu/LiteOrm/tree/master/LiteOrm.Demo/Demos/MySqlBulkInsertProvider.cs) 示例） |
...
参考文档：
- [配置项速查](./configuration-reference.md)
