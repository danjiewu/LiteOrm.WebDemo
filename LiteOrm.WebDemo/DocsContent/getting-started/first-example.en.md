...
>
> If you do not want a DI container at all, see [First Full Example (Manual, No DI)](./first-example-manual.en.md). If you use ASP.NET Core and need Autofac integration, AOP transactions/permissions/logging, and similar capabilities, see [First End-to-End Example (DI)](./first-example-di.en.md).
...
The full parameter table, multi-source setup, transaction usage, and a walkthrough live in [First Full Example (Manual, No DI)](./first-example-manual.en.md).
...
- [First End-to-End Example (DI)](./first-example-di.en.md)
