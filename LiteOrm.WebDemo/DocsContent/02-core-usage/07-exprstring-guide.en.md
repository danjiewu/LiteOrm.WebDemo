...
### 10.1 Wrapping an interpolation hole inside a LIKE pattern
...
### 10.2 Inserting a column name as a plain value
...
### 10.3 Hardcoding a single-dialect quote character
...
### 10.4 Forgetting `isFull: true` for full SQL
...
### 10.5 Re-inserting the main-table FromExpr
...
### 10.6 Expecting CommonTableExpr to auto-expand
...
### 10.7 Calling ExprString from the Service layer
...
### 10.8 Subquery SelectExpr before FromExpr, no alias
