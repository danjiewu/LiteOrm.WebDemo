...
This approach is suitable for dynamic computation logic that cannot be statically declared via the `[Column]` attribute. For the complete steps (including SQL function handler registration), see [Expression Extension — Example 2: Computed Properties](../extensibility/expression-extension.en.md#5-example-2-computed-properties).
...
For more details, see [Sharding and TableArgs](../advanced-topics/sharding-and-tableargs.en.md).
...
- [View Models and Services](./view-models-and-services.en.md)
