...
The multi-service parallel batch-initialization pattern is captured in [CRUD guide § Batch initialization example](../core-usage/crud-guide.en.md) — not repeated here.
